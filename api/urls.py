...
urlpatterns =[
    ...
    #Payment Endpoints
    path('stripe-checkout/<str:order_oid>/',store_views.StripeCheckoutView.as_view()),
    ...
    path('vendor-notification-mark-as-seen/<vendor_id>/', vendor_views.NotificationVendorMarkAsSeen.as_view()),
